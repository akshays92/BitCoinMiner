defmodule PROJECT1 do
  ...
  def main(args) do
    ...
    if String.contains?(input_arguements,".") do
      ...
      PROJECT1.Server.start_link()
      spawnXminingThreads(0, 36, inputstring, string2)
  ...
  def spawnXminingThreads(count, intx, inputstring, string2) when count < intx do
    spawn(PROJECT1.Miner,:minecoins, [self(), 0, PROJECT1.Server.getInputString(:CoinServer,inputstring), string2])
